<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Arrangement1.aspx.cs" Inherits="Arrangement1" %>
  ...
  margin: 5px;
    ...
    <script>
        ...
        function createseating() {
            ...
            var ID1 = document.getElementById('BOX4').value;
            console.log(column);
            console.log(seat);
            var arr = seat.split(',');
            var ids = ID.split(',');
                ...
                for (var j = 0; j < arr2[k]; j++) {
                    if (i % 2 == 0) {
                        ...
                        if (h < ids.length) {
                            ...
                            var seatingStyle = "<div class='seat sel'><font size='1pt'>" + ids[h] + "</font></div>";
                        ...
                        if (m < id1.length) {
                            ...
                            var seatingStyle = "<div class='seat selected'><font size='1pt'>" + id1[m] + "</font></div>";
                            seatingValue.push(seatingStyle);
                            m++;
