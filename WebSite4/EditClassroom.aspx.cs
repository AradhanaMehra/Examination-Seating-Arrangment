        ...
        if (!object.Equals(ds.Tables[0], null))
        {
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    htmlTable.Append("<tr>");
                    htmlTable.Append("<form runat='server' method=\"POST\" action=\\EditClass.aspx?id=" + ds.Tables[0].Rows[i]["ID"] + ">");
                    ...
                    htmlTable.Append("<td> <input class='button' type='submit' value='Edit' > </td>");
